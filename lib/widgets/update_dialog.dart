              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // APK 架构选择提示（如果有多个 APK）
                    if (versionInfo.apkUrls.isNotEmpty) ...[
                      const SizedBox(height: 12),
                      Container(
                        padding: const EdgeInsets.all(12),
                        decoration: BoxDecoration(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                '推荐下载: ${versionInfo.recommendedApkType}',
                                style: FontUtils.poppins(
                                  fontSize: 13,
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () async {
                          // 优先使用推荐的 APK 下载链接
                          final apkUrl = versionInfo.preferredApkUrl;
                          String url;
                          
                          if (apkUrl != null && apkUrl.isNotEmpty) {
                            url = apkUrl;
                          } else {
                            url = VersionService.getReleaseUrl(
                                versionInfo.latestVersion);
                          }
                        ...
                        label: Text(
                          versionInfo.apkUrls.isNotEmpty ? '下载更新' : '查看新版本',
                          style: FontUtils.poppins(
                            fontSize: 15,
                            fontWeight: FontWeight.w600,
                          ),
