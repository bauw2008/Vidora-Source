...
class _UserMenuState extends State<UserMenu> {
  ...
  Future<void> _handleCheckUpdate() async {
    try {
      ...
      // 手动检查时使用强制检查，不受每天一次限制
      final versionInfo = await VersionService.checkForUpdate(forceCheck: true);
                  ...
                  child: Container(
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          final url = Uri.parse(
                              'https://github.com/bauw2008/Vidora-Source');
